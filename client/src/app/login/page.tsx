...
export default function LoginPage() {
    ...
    // Show error toast if there's an error from NextAuth
    if (error) {
            ...
            >
                ...
                <Card className="border-border">
                    <CardHeader className="space-y-1">
                        <CardTitle className="text-2xl font-bold text-center">Welcome to LeetWars</CardTitle>
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <div className="space-y-3">
                            ...
                            >
                                {isLoading === 'github' ? (
                                    ...
                                    <span className="mr-3"><GitHubIcon /></span>
                                )}
                        ...
                        <div className="text-center space-y-2 text-sm text-muted-foreground">
                            ...
                            <p className="text-xs">
                                New users will be asked to provide their LeetCode username to complete registration.
                            </p>
                        </div>
                    </CardContent>
                </Card>
                ...
                >
                    <p className="mb-2">🏆 Create and join coding contests</p>
                    <p>🤖 Get AI-powered coaching and analysis</p>
                </motion.div>
            </motion.div>
        </div>
    );
