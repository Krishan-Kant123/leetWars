...
interface CompanySearchSectionProps {
    onProblemAdd: (problem: any) => void;
    selectedProblems: any[];
}

export function CompanySearchSection({ onProblemAdd, selectedProblems }: CompanySearchSectionProps) {
    ...
    const handleAddProblem = (problem: CompanyProblem) => {
        // Convert CompanyProblem to the format expected by the parent
                                    ...
                                    >
                                        <div className="flex items-start justify-between gap-3">
                                            ...
                                            <Button
                                                ...
                                                size="sm"
                                                onClick={() => !isSelected && handleAddProblem(problem)}
                                                disabled={isSelected}
                                            >
                                                {isSelected ? (
                                                    <>
